.PHONY: help setup setup-hooks infra infra-down infra-reset acquire parse resolve load enrich test lint typecheck format clean pipeline validate-staging
